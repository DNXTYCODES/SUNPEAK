  ...
  const featuredTech = [
    {
      id: 1,
      name: 'Apple',
      video: assets.iphone_video,
      logo: assets.apple_logo,
    },
    {
      id: 2,
      name: 'Samsung',
      video: assets.galaxy_video,
      logo: assets.samsung_logo,
    },
    {
      id: 3,
      name: 'Dell',
      video: assets.dell_video,
      logo: assets.dell_logo,
    },
    {
      id: 4,
      name: 'Sony',
      video: assets.sony_video,
      logo: assets.sony_logo,
    },
  ];

  const otherBrands = [
    { id: 1, name: 'Microsoft', logo: assets.microsoft_logo },
    { id: 2, name: 'Google', logo: assets.google_logo },
    { id: 3, name: 'HP', logo: assets.hp_logo },
    { id: 4, name: 'Lenovo', logo: assets.lenovo_logo },
    { id: 5, name: 'LG', logo: assets.lg_logo },
    { id: 6, name: 'Asus', logo: assets.asus_logo },
    { id: 7, name: 'Bose', logo: assets.bose_logo },
  ];

  return (
    <div className="py-16 px-6 bg-gray-50">
      <h2 className="text-3xl font-bold text-center mb-10 bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">
        Featured Tech
      </h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {featuredTech.map((tech) => (
          <div
            key={tech.id}
            className="relative group border border-gray-200 rounded-xl shadow-lg overflow-hidden hover:scale-105 transition-transform duration-300"
          >
            <video
              src={tech.video}
              ...
              preload="auto"
            />
            <div className="absolute bottom-4 left-4 flex items-center bg-black/50 px-4 py-2 rounded-xl gap-3">
              <img
                src={tech.logo}
                alt={`${tech.name} brand`}
      ...
      <h2 className="text-2xl font-bold text-center mt-16 mb-10 bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">
        Top Tech Brands
      </h2>
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-4">
        {otherBrands.map((brand) => (
          <div
            key={brand.id}
            className="flex items-center bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow"
          >
            <img
              src={brand.logo}
              alt={brand.name}
...
//   return (
//     <div className="py-16 px-6 bg-[#FEF3ED] ">
