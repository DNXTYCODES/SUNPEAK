...
//   return (
//     <nav className={`fixed w-full z-50 backdrop-blur-md bg-[var(--bg)/70] border-b border-[var(--border)]`}>
...
//   return (
//     <nav className={`fixed w-full z-50 transition-all duration-300 backdrop-blur-lg bg-[var(--bg)/80] border-b border-[var(--border)]`}>
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//         <div className="flex items-center justify-between h-20">
//           {/* Logo */}
//           <Link 
...
//             <button 
//               onClick={toggleTheme}
//               className="p-2 rounded-lg hover:bg-[var(--primary-neon)/10] transition-colors text-[var(--text)]"
//             >
//               {theme === 'dark' ? 'Light Mode' : 'Dark Mode'}
//             </button>
//             <button
...
//   return (
//     <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-[var(--bg)]/80 backdrop-blur-lg border-b border-[var(--border)]' : 'bg-transparent'}`}>
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//         <div className="flex items-center justify-between h-20">
//           {/* Logo */}
//           <Link 
...
//             <button 
//               onClick={toggleTheme}
//               className="p-2 text-sm font-medium rounded-lg hover:bg-[var(--primary-neon)/10] transition-colors"
//             >
//               {theme === 'dark' ? 'Light Mode' : 'Dark Mode'}
//             </button>
//             <button
...
//       {/* Mobile Menu */}
//       <div className={`lg:hidden fixed inset-0 z-40 transition-transform duration-300 ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
//         <div className="absolute inset-0 bg-[var(--bg)/90] backdrop-blur-lg">
//           <div className="flex flex-col h-full p-6">
//             <div className="flex justify-between items-center mb-8">
//               <span className="text-2xl font-bold text-[var(--primary-neon)]">Menu</span>
//               <button 
