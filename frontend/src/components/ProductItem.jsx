...
//     const [isLiked, setIsLiked] = useState(false); // Now properly imported

//     return (
//         <div className="group relative bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 border border-gray-100">
//             {/* Wishlist Button */}
//             {/* <button 
//                 onClick={(e) => {
//                     e.preventDefault();
...
//                             //     addToCart(id);
//                             // }}
//                             className="bg-green-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-700 transition-colors"
//                         >
//                             {/* Add to Cart */}
